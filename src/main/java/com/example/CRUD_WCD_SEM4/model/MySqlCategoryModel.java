    ...
    public Category findById(int id) {
        try {
            ...
            while (rs.next()){
                ...
                Category category = new Category(id , name, categoryStatus);
                return category;
            }
        }catch (SQLException e){
            System.out.println(e);
